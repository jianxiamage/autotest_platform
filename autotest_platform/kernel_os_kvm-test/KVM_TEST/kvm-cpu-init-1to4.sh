...
retCode=0
#----------------------------------------------------------------
cmdEndStr="KVM Test:Set init value(1to4) to cpu info of the KVM End----------------------------"
KVMIP=''
retCode=0
cpuInputNum=0
#----------------------------------------------------------------------------------
...
write_log "INFO" "KVM Test: Set init value(1to4) to cpu info of the KVM Begin----------------------------"
...
#Begin to modify the kvm xml file to init value configuration
