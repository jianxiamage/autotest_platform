...
cpuInputNum=0
#----------------------------------------------------------------
cmdEndStr="KVM Test:Set the init value(2to4) to cpu info of the KVM End----------------------------"
KVMIP=''
retCode=0
#----------------------------------------------------------------------------------
...
write_log "INFO" "KVM Test: Set the init value(2to4) cpu info of the KVM Begin----------------------------"
...
#vcpuSetStr="<vcpu placement='static' current='2'>4</vcpu>"
vcpuSetStr="  <vcpu placement='static' current='2'>4</vcpu>"
